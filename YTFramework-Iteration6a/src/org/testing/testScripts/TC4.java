...
public class TC4 extends Base
{
	...
	public void history() throws InterruptedException, IOException
	{
		...
		LogsCapture.takeLogs("TC4", "Login success");
		
		//URL matching using hard assertion
		 String expected_url="https://www.youtube.com/";             
		 String actual_url=driver.getCurrentUrl(); 
		 Assert.assertEquals(expected_url, actual_url);
		 LogsCapture.takeLogs("TC4", "Hard assertion for URL matching is true");
		 
		//screenshot capture
		String mypath="E:\\screenshots\\"+"TC4_"+DateCalculation.calculateDate()+".png";
		...
		LogsCapture.takeLogs("TC4", "Soft assertion of email matching is true");
		...
		s1.logout();
		LogsCapture.takeLogs("TC4", "Logout success");
