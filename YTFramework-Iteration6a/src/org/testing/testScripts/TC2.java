...
public class TC2 extends Base
{
	...
	public void subscriptions() throws InterruptedException, IOException
	{
		...
		LogsCapture.takeLogs("TC2", "Login success");
		
		//URL matching using hard assertion
		 String expected_url="https://www.youtube.com/";             
		 String actual_url=driver.getCurrentUrl(); 
		 Assert.assertEquals(expected_url, actual_url);
		 LogsCapture.takeLogs("TC2", "Hard assertion for URL matching is true");
		
		 //screenshot capture
		 String mypath="E:\\screenshots\\"+"TC2_"+DateCalculation.calculateDate()+".png";
		 ScreenshotCapture.takeScreenshot(driver, mypath);
		  ...
		  //expected and actual email matching using soft assertion passed to hard assertion
			...
			LogsCapture.takeLogs("TC2", "Soft assertion of email matching is true");
		...
		s1.logout();
		LogsCapture.takeLogs("TC2", "Logout success");
